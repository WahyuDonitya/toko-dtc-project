        ...
        <div class="card-body">
            ...
            <form id="formBarangMasuk" method="POST" action="{{ route('barang-masuk.store') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label for="mengetahui" class="form-label">Penanggung Jawab</label>
                        <div class="input-group">
                        ...
                        response.details.forEach(function(detail) {
                            let row = `
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" name="jumlah_datang[]" value="${detail.jumlah - detail.jumlah_barangditerima}" class="form-control" required>
                                    </td>
                                    <td>
